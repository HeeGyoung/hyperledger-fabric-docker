...
### To upgrade chaincode, CHAINCODE_VERSION and CHAINCODE_SEQUENCE have to be increased.
### ex) 1.0 -> 1.1 / 1 -> 2
...
warnBoldln "8. chaincodeInvokeInit"
...
warnBoldln "9.(Call UpdateChaincodeTest) chaincodeQuery 1"
chaincodeQuery 1 '{"function":"UpdateChaincodeTest","Args":["asset7"]}' localhost:7051
chaincodeQuery 1 '{"function":"UpdateChaincodeTest","Args":["asset7"]}' localhost:7054
warnBoldln "9.(Call UpdateChaincodeTest) chaincodeQuery 2"
chaincodeQuery 2 '{"function":"UpdateChaincodeTest","Args":["asset7"]}' localhost:9051
